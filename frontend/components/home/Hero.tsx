...
const Hero = () => {
    return (
        <div className="mt-32 flex flex-col gap-6 relative perspective-[3000px] min-h-[900px] max-w-screen ">
            <h1 className="text-6xl font-bold max-w-4xl tracking-tight leading-[1.1]">
                Save anything.<br />
                Find it everywhere.
            </h1>
            <p className="text-neutral-400 max-w-lg text-lg tracking-wide">Your bookmarks, synced across every device the moment you save them. No more lost links, no more digging through browser folders.</p>
